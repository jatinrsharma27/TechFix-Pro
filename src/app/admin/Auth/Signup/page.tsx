  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setTimeout(() => {
          router.push(`/admin/Auth/otp?email=${encodeURIComponent(formData.email)}&purpose=signup&full_name=${encodeURIComponent(formData.fullName)}&password=${encodeURIComponent(formData.password)}`);
        }, 1000);
      } else {
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <a href="/admin/Auth/Signin" className="font-medium text-blue-600 hover:text-blue-500 transition-colors">
                    Admin Sign in
                  </a>
                </p>
              </div>
