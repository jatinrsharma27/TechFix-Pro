  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          router.push(`/admin/Auth/otp?email=${encodeURIComponent(formData.email)}&purpose=signin`);
        }, 1000);
      } else {
      ...
      showToast('Server error. Please check if the admin system is properly configured.', 'error');
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="/admin/Auth/Forgot-password" className="font-medium text-blue-600 hover:text-blue-500 transition-colors">
                    Forgot password?
                  </a>
                </div>
              </div>
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  Need admin access?{' '}
                  <a href="/admin/Auth/Signup" className="font-medium text-blue-600 hover:text-blue-500 transition-colors">
                    Sign up
                  </a>
                </p>
              </div> */}
