...
const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        router.push(`/user/Auth/otp?email=${encodeURIComponent(formData.email)}&purpose=signup&full_name=${encodeURIComponent(formData.fullName)}&password=${encodeURIComponent(formData.password)}`);
      } else {
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <a href="/user/Auth/Signin" className="font-medium text-blue-600 hover:text-blue-500 transition-colors">
                    Sign in
                  </a>
                </p>
              </div>
