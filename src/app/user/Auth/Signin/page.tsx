...
const SigninPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        router.push(`/user/Auth/otp?email=${encodeURIComponent(formData.email)}&purpose=signin`);
      } else {
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="/user/Auth/Forgot-password" className="font-medium text-blue-600 hover:text-blue-500 transition-colors">
                    Forgot password?
                  </a>
                </div>
              </div>
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <a href="/user/Auth/Signup" className="font-medium text-blue-600 hover:text-blue-500 transition-colors">
                    Sign up
                  </a>
                </p>
              </div>
