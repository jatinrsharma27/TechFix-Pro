        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Professional electronic repair services with over 15 years of experience. 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="hover:text-white cursor-pointer transition-colors">Phone Repair</li>
              <li className="hover:text-white cursor-pointer transition-colors">Laptop Repair</li>
              <li className="hover:text-white cursor-pointer transition-colors">TV Repair</li>
              <li className="hover:text-white cursor-pointer transition-colors">Gaming Console</li>
              <li className="hover:text-white cursor-pointer transition-colors">Tablet Repair</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <div className="flex items-center">
                ...
                <span>123 Repair Street, Tech City, LA</span>
              </div>
              <div className="flex items-center">
